    ...
    return (
        <div className="flex min-h-screen flex-col bg-[#030303]">
            ...
            <div
                ...
                style={{
                    background: `
                        radial-gradient(ellipse 80% 50% at 50% -10%, rgba(99, 102, 241, 0.08), transparent 50%),
                        radial-gradient(ellipse 60% 40% at 80% 60%, rgba(139, 92, 246, 0.05), transparent 50%),
                        radial-gradient(ellipse 50% 30% at 20% 80%, rgba(168, 85, 247, 0.05), transparent 50%)
                    `
                }}
            />
            ...
            <main className="flex-1 pt-20 relative">
                ...
                <SectionTransition id="pricing-to-footer" from="#030303" to="#0a0e1a" height="100px" />
            </main>
            <Footer />
        </div>
    )
